---
name: x-draft-import-order
description: Import statement ordering convention for x-draft, mirrored from x-design. Load before writing or reviewing the import block of any .ts/.tsx file — covers external-package ordering, the `// category` comment groups, alphabetical group ordering, and default-vs-named import precedence.
---

# x-draft Import Order

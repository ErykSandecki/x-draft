...
describe('useRectangleTool behaviors', () => {
  it('should not react to pointer events when the rectangle tool is not active', () => {
    // mock
    ...
    // before
    renderHook(() => useRectangleTool(canvasRef, draftRef), {
  ...
  it('should commit a rectangle node with a fixed fill and switch back to the default tool on pointer up', () => {
    // mock
    const store = createTestStore();

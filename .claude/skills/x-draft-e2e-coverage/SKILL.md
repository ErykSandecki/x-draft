...
[[x-draft-playwright-mcp-testing]] — the two different browser-testing paths (automated
...
[[x-draft-test-conventions]] — unit test structure/step-comment convention; unrelated axis (applies

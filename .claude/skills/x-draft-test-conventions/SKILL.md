...
description: Unit test structure and step-comment convention for x-draft, mirrored from x-design. Load before writing or reviewing any .spec.ts(x) file — covers describe/it naming and the // mock / // spy / // before / // find / // action / // wait / // result step comments.
---
...
Both follow the nested `test/` placement from [[x-draft-module-structure]] (components co-locate
